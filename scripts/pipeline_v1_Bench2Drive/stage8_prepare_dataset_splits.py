...
Stage 7 now emits one VQA sample per named target agent, while all target-agent
...
keeping Bench2Drive actor ids and raw agent ids out of the conversation target.
"""
